    ...
    ui(new Ui::Sudoku)
{
    ...
    ui->r1->setText(QString::number(vector.at(0)));
    ui->r1->setDisabled(true);
    ui->r5->setText(QString::number(vector.at(4)));
    ui->r5->setDisabled(true);
    ui->r7->setText(QString::number(vector.at(6)));
    ui->r7->setDisabled(true);
    ui->r2_2->setText(QString::number(vector.at(2)));
    ui->r2_2->setDisabled(true);;
    ui->r6_2->setText(QString::number(vector.at(6)));
    ui->r6_2->setDisabled(true);
    ui->r2_3->setText(QString::number(vector.at(3)));
    ui->r2_3->setDisabled(true);
    ui->r6_3->setText(QString::number(vector.at(7)));
    ui->r6_3->setDisabled(true);
    ui->r9_3->setText(QString::number(vector.at(1)));
    ui->r9_3->setDisabled(true);
    ui->r3_4->setText(QString::number(vector.at(5)));
    ui->r3_4->setDisabled(true);
    ui->r6_4->setText(QString::number(vector.at(8)));
    ui->r6_4->setDisabled(true);
    ui->r7_5->setText(QString::number(vector.at(1)));
    ui->r7_5->setDisabled(true);
    ui->r4_6->setText(QString::number(vector.at(8)));
    ui->r4_6->setDisabled(true);
    ui->r6_6->setText(QString::number(vector.at(1)));
    ui->r6_6->setDisabled(true);
    ui->r1_7->setText(QString::number(vector.at(6)));
    ui->r1_7->setDisabled(true);
    ui->r3_7->setText(QString::number(vector.at(8)));
    ui->r3_7->setDisabled(true);
    ui->r6_7->setText(QString::number(vector.at(2)));
    ui->r6_7->setDisabled(true);
    ui->r3_8->setText(QString::number(vector.at(0)));
    ui->r3_8->setDisabled(true);
    ui->r2_9->setText(QString::number(vector.at(0)));
    ui->r2_9->setDisabled(true);
    ui->r5_9->setText(QString::number(vector.at(3)));
    ui->r5_9->setDisabled(true);
    ui->r9_9->setText(QString::number(vector.at(7)));
...
void Sudoku::print(){
    ...
    if ( ui->r1->text() == QString::number(vector.at(0))
         && ui->r2->text()== QString::number(vector.at(1))
         &&  ui->r3->text() == QString::number(vector.at(2))
         && ui->r4->text() == QString::number(vector.at(3))
         && ui->r5->text() == QString::number(vector.at(4))
         && ui->r6->text() == QString::number(vector.at(5))
         && ui->r7->text() == QString::number(vector.at(6))
         && ui->r8->text() == QString::number(vector.at(7))
         && ui->r9->text() == QString::number(vector.at(8))

         && ui->r1_2->text() == QString::number(vector.at(1))
         && ui->r2_2->text()== QString::number(vector.at(2))
         &&  ui->r3_2->text() == QString::number(vector.at(3))
         && ui->r4_2->text() == QString::number(vector.at(4))
         && ui->r5_2->text() == QString::number(vector.at(5))
         && ui->r6_2->text() == QString::number(vector.at(6))
         && ui->r7_2->text() == QString::number(vector.at(7))
         && ui->r8_2->text() == QString::number(vector.at(8))
         && ui->r9_2->text() == QString::number(vector.at(0))

         && ui->r1_3->text() == QString::number(vector.at(2))
         && ui->r2_3->text()== QString::number(vector.at(3))
         && ui->r3_3->text() == QString::number(vector.at(4))
         && ui->r4_3->text() == QString::number(vector.at(5))
         && ui->r5_3->text() == QString::number(vector.at(6))
         && ui->r6_3->text() == QString::number(vector.at(7))
         && ui->r7_3->text() == QString::number(vector.at(8))
         && ui->r8_3->text() == QString::number(vector.at(0))
         && ui->r9_3->text() == QString::number(vector.at(1))

         && ui->r1_4->text() == QString::number(vector.at(3))
         && ui->r2_4->text()== QString::number(vector.at(4))
         && ui->r3_4->text() == QString::number(vector.at(5))
         && ui->r4_4->text() == QString::number(vector.at(6))
         && ui->r5_4->text() == QString::number(vector.at(7))
         && ui->r6_4->text() == QString::number(vector.at(8))
         && ui->r7_4->text() == QString::number(vector.at(0))
         && ui->r8_4->text() == QString::number(vector.at(1))
         && ui->r9_4->text() == QString::number(vector.at(2))

         && ui->r1_5->text() == QString::number(vector.at(4))
         && ui->r2_5->text()== QString::number(vector.at(5))
         && ui->r3_5->text() == QString::number(vector.at(6))
         && ui->r4_5->text() == QString::number(vector.at(7))
         && ui->r5_5->text() == QString::number(vector.at(8))
         && ui->r6_5->text() == QString::number(vector.at(0))
         && ui->r7_5->text() == QString::number(vector.at(1))
         && ui->r8_5->text() == QString::number(vector.at(2))
         && ui->r9_5->text() == QString::number(vector.at(3))

         && ui->r1_6->text() == QString::number(vector.at(5))
         && ui->r2_6->text()== QString::number(vector.at(6))
         && ui->r3_6->text() == QString::number(vector.at(7))
         && ui->r4_6->text() == QString::number(vector.at(8))
         && ui->r5_6->text() == QString::number(vector.at(0))
         && ui->r6_6->text() == QString::number(vector.at(1))
         && ui->r7_6->text() == QString::number(vector.at(2))
         && ui->r8_6->text() == QString::number(vector.at(3))
         && ui->r9_6->text() == QString::number(vector.at(4))

         && ui->r1_7->text() == QString::number(vector.at(6))
         && ui->r2_7->text()== QString::number(vector.at(7))
         && ui->r3_7->text() == QString::number(vector.at(8))
         && ui->r4_7->text() == QString::number(vector.at(0))
         && ui->r5_7->text() == QString::number(vector.at(1))
         && ui->r6_7->text() == QString::number(vector.at(2))
         && ui->r7_7->text() == QString::number(vector.at(3))
         && ui->r8_7->text() == QString::number(vector.at(4))
         && ui->r9_7->text() == QString::number(vector.at(5))

         && ui->r1_8->text() == QString::number(vector.at(7))
         && ui->r2_8->text()== QString::number(vector.at(8))
         && ui->r3_8->text() == QString::number(vector.at(0))
         && ui->r4_8->text() == QString::number(vector.at(1))
         && ui->r5_8->text() == QString::number(vector.at(2))
         && ui->r6_8->text() == QString::number(vector.at(3))
         && ui->r7_8->text() == QString::number(vector.at(4))
         && ui->r8_8->text() == QString::number(vector.at(5))
         && ui->r9_8->text() == QString::number(vector.at(6))

         && ui->r1_9->text() == QString::number(vector.at(8))
         && ui->r2_9->text()== QString::number(vector.at(0))
         && ui->r3_9->text() == QString::number(vector.at(1))
         && ui->r4_9->text() == QString::number(vector.at(2))
         && ui->r5_9->text() == QString::number(vector.at(3))
         && ui->r6_9->text() == QString::number(vector.at(4))
         && ui->r7_9->text() == QString::number(vector.at(5))
         && ui->r8_9->text() == QString::number(vector.at(6))
         && ui->r9_9->text() == QString::number(vector.at(7))
...
void Sudoku::on_Generate_clicked()
{
    ...
    ui->Show->hide();
    ui->r1->setText(QString::number(vector.at(0)));
    ui->r7->setText(QString::number(vector.at(3)));
    ui->r1_2->setText(QString::number(vector.at(3)));
    ui->r7_2->setText(QString::number(vector.at(2)));
...
{
    ui->r1->setText(QString::number(vector.at(0)));
    ui->r2->setText(QString::number(vector.at(1)));
    ui->r3->setText(QString::number(vector.at(2)));
    ui->r4->setText(QString::number(vector.at(3)));
    ui->r5->setText(QString::number(vector.at(4)));
    ui->r6->setText(QString::number(vector.at(5)));
    ui->r7->setText(QString::number(vector.at(6)));
    ui->r8->setText(QString::number(vector.at(7)));
    ui->r9->setText(QString::number(vector.at(8)));

    ui->r1_2->setText(QString::number(vector.at(1)));
    ui->r2_2->setText(QString::number(vector.at(2)));
    ui->r3_2->setText(QString::number(vector.at(3)));
    ui->r4_2->setText(QString::number(vector.at(4)));
    ui->r5_2->setText(QString::number(vector.at(5)));
    ui->r6_2->setText(QString::number(vector.at(6)));
    ui->r7_2->setText(QString::number(vector.at(7)));
    ui->r8_2->setText(QString::number(vector.at(8)));
    ui->r9_2->setText(QString::number(vector.at(0)));

    ui->r1_3->setText(QString::number(vector.at(2)));
    ui->r2_3->setText(QString::number(vector.at(3)));
    ui->r3_3->setText(QString::number(vector.at(4)));
    ui->r4_3->setText(QString::number(vector.at(5)));
    ui->r5_3->setText(QString::number(vector.at(6)));
    ui->r6_3->setText(QString::number(vector.at(7)));
    ui->r7_3->setText(QString::number(vector.at(8)));
    ui->r8_3->setText(QString::number(vector.at(0)));
    ui->r9_3->setText(QString::number(vector.at(1)));

    ui->r1_4->setText(QString::number(vector.at(3)));
    ui->r2_4->setText(QString::number(vector.at(4)));
    ui->r3_4->setText(QString::number(vector.at(5)));
    ui->r4_4->setText(QString::number(vector.at(6)));
    ui->r5_4->setText(QString::number(vector.at(7)));
    ui->r6_4->setText(QString::number(vector.at(8)));
    ui->r7_4->setText(QString::number(vector.at(0)));
    ui->r8_4->setText(QString::number(vector.at(1)));
    ui->r9_4->setText(QString::number(vector.at(2)));

    ui->r1_5->setText(QString::number(vector.at(4)));
    ui->r2_5->setText(QString::number(vector.at(5)));
    ui->r3_5->setText(QString::number(vector.at(6)));
    ui->r4_5->setText(QString::number(vector.at(7)));
    ui->r5_5->setText(QString::number(vector.at(8)));
    ui->r6_5->setText(QString::number(vector.at(0)));
    ui->r7_5->setText(QString::number(vector.at(1)));
    ui->r8_5->setText(QString::number(vector.at(2)));
    ui->r9_5->setText(QString::number(vector.at(3)));

    ui->r1_6->setText(QString::number(vector.at(5)));
    ui->r2_6->setText(QString::number(vector.at(6)));
    ui->r3_6->setText(QString::number(vector.at(7)));
    ui->r4_6->setText(QString::number(vector.at(8)));
    ui->r5_6->setText(QString::number(vector.at(0)));
    ui->r6_6->setText(QString::number(vector.at(1)));
    ui->r7_6->setText(QString::number(vector.at(2)));
    ui->r8_6->setText(QString::number(vector.at(3)));
    ui->r9_6->setText(QString::number(vector.at(4)));

    ui->r1_7->setText(QString::number(vector.at(6)));
    ui->r2_7->setText(QString::number(vector.at(7)));
    ui->r3_7->setText(QString::number(vector.at(8)));
    ui->r4_7->setText(QString::number(vector.at(0)));
    ui->r5_7->setText(QString::number(vector.at(1)));
    ui->r6_7->setText(QString::number(vector.at(2)));
    ui->r7_7->setText(QString::number(vector.at(3)));
    ui->r8_7->setText(QString::number(vector.at(4)));
    ui->r9_7->setText(QString::number(vector.at(5)));

    ui->r1_8->setText(QString::number(vector.at(7)));
    ui->r2_8->setText(QString::number(vector.at(8)));
    ui->r3_8->setText(QString::number(vector.at(0)));
    ui->r4_8->setText(QString::number(vector.at(1)));
    ui->r5_8->setText(QString::number(vector.at(2)));
    ui->r6_8->setText(QString::number(vector.at(3)));
    ui->r7_8->setText(QString::number(vector.at(4)));
    ui->r8_8->setText(QString::number(vector.at(5)));
    ui->r9_8->setText(QString::number(vector.at(6)));

    ui->r1_9->setText(QString::number(vector.at(8)));
    ui->r2_9->setText(QString::number(vector.at(0)));
    ui->r3_9->setText(QString::number(vector.at(1)));
    ui->r4_9->setText(QString::number(vector.at(2)));
    ui->r5_9->setText(QString::number(vector.at(3)));
    ui->r6_9->setText(QString::number(vector.at(4)));
    ui->r7_9->setText(QString::number(vector.at(5)));
    ui->r8_9->setText(QString::number(vector.at(6)));
    ui->r9_9->setText(QString::number(vector.at(7)));
}
